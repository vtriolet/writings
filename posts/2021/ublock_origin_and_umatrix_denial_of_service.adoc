...
*uMatrix remains unpatched and unmaintained*.
...
*Edit*: This post previously included mitigations that were incomplete and potentially misleading for users with customized rules.
As a result, I no longer feel comfortable making general recommendations for securing uMatrix installations, if that is indeed possible.
I apologize for any confusion that I've caused, especially because some of the flawed mitigations have been quoted elsewhere.
